...
make clean
```
Or, if you prefer to use the Docker system implemented in the Avocet Framework: 

```dockerfile
# Build the compiler container environment
docker compose build

# Compile framework and generate binaries
docker compose run --rm compiler make
```
